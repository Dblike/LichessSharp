...
public interface IExternalEngineApi
{
    ...
    Task<ExternalEngine> CreateAsync(ExternalEngineRegistration registration,
    ...
    Task<ExternalEngine> UpdateAsync(string engineId, ExternalEngineRegistration registration,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<EngineAnalysisLine> AnalyseAsync(string engineId, EngineAnalysisRequest request,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task SubmitWorkAsync(string workId, IAsyncEnumerable<string> uciLines,
        CancellationToken cancellationToken = default);
}
