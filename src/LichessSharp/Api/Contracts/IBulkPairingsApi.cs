...
public interface IBulkPairingsApi
{
    ...
    Task<string> ExportGamesAsync(string id, BulkPairingExportOptions? options = null,
    ...
    IAsyncEnumerable<GameJson> StreamGamesAsync(string id, BulkPairingExportOptions? options = null,
        CancellationToken cancellationToken = default);
}
