...
public interface IUsersApi
{
    ...
    Task<IReadOnlyList<UserStatus>> GetRealTimeStatusAsync(IEnumerable<string> userIds,
    ...
    Task<IReadOnlyList<User>> GetLeaderboardAsync(string perfType, int count = 100,
    ...
    Task<UserExtended> GetAsync(string username, GetUserOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<RatingHistory>> GetRatingHistoryAsync(string username,
        CancellationToken cancellationToken = default);
    ...
    Task<UserPerformance> GetPerformanceAsync(string username, string perfType,
        CancellationToken cancellationToken = default);
    ...
    Task<Crosstable> GetCrosstableAsync(string user1, string user2, bool matchup = false,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<string>> AutocompleteAsync(string term, bool asObject = false, string? friend = null,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<AutocompletePlayer>> AutocompletePlayersAsync(string term, string? friend = null,
        CancellationToken cancellationToken = default);
