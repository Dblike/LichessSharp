...
public interface IStudiesApi
{
    ...
    Task<string> ExportChapterPgnAsync(string studyId, string chapterId, StudyExportOptions? options = null,
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>PGN content as a string.</returns>
    Task<string> ExportStudyPgnAsync(string studyId, StudyExportOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>PGN content as a string.</returns>
    Task<string> ExportUserStudiesPgnAsync(string username, StudyExportOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<StudyMetadata> StreamUserStudiesAsync(string username,
        CancellationToken cancellationToken = default);
    ...
    Task<StudyImportResult> ImportPgnAsync(string studyId, string pgn, StudyImportOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    Task<bool> UpdateChapterTagsAsync(string studyId, string chapterId, string pgnTags,
        CancellationToken cancellationToken = default);
