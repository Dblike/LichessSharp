...
public interface IPuzzlesApi
{
    ...
    Task<PuzzleWithGame> GetNextAsync(string? angle = null, string? difficulty = null,
    ...
    Task<PuzzleBatch> GetBatchAsync(string angle, int? nb = null, string? difficulty = null, string? color = null,
        CancellationToken cancellationToken = default);
    ...
    Task<PuzzleBatchResult> SolveBatchAsync(string angle, IEnumerable<PuzzleSolution> solutions, int? nb = null,
        CancellationToken cancellationToken = default);
    ...
    Task<StormDashboard> GetStormDashboardAsync(string username, int days = 30,
        CancellationToken cancellationToken = default);
