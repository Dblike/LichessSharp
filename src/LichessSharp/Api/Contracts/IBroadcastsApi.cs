...
public interface IBroadcastsApi
{
    ...
    IAsyncEnumerable<BroadcastWithRounds> StreamOfficialBroadcastsAsync(int? nb = null, bool? html = null, CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<BroadcastByUser> StreamUserBroadcastsAsync(string username, int? nb = null, bool? html = null, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastSearchPage> SearchBroadcastsAsync(string query, int? page = null, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastWithRounds> GetTournamentAsync(string broadcastTournamentId, bool? html = null, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastRound> GetRoundAsync(string broadcastTournamentSlug, string broadcastRoundSlug, string broadcastRoundId, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastWithRounds> CreateTournamentAsync(BroadcastTournamentOptions options, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastWithRounds> UpdateTournamentAsync(string broadcastTournamentId, BroadcastTournamentOptions options, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastRoundNew> CreateRoundAsync(string broadcastTournamentId, BroadcastRoundOptions options, CancellationToken cancellationToken = default);
    ...
    Task<BroadcastRoundNew> UpdateRoundAsync(string broadcastRoundId, BroadcastRoundOptions options, CancellationToken cancellationToken = default);
