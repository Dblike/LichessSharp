...
public interface IGamesApi
{
    ...
    Task<GameJson> ExportAsync(string gameId, ExportGameOptions? options = null,
    ...
    Task<string> GetPgnAsync(string gameId, ExportGameOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The game in JSON format.</returns>
    Task<GameJson> GetCurrentGameByUserAsync(string username, ExportGameOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<GameJson> StreamByUsersAsync(IEnumerable<string> userIds, bool withCurrentGames = false,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<GameJson> StreamByIdsAsync(IEnumerable<string> gameIds, ExportGameOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Stream of games.</returns>
    IAsyncEnumerable<GameJson> StreamUserGamesAsync(string username, ExportUserGamesOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<GameStreamEvent> StreamByIdsAsync(string streamId, IEnumerable<string> gameIds,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task AddGameIdsToStreamAsync(string streamId, IEnumerable<string> gameIds,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<MoveStreamEvent>
        StreamGameMovesAsync(string gameId, CancellationToken cancellationToken = default);
