...
public interface ITvApi
{
    ...
    /// </summary>
    /// <param name="channel">
    ///     The channel name in camelCase (e.g., "bullet", "blitz", "rapid", "classical", "ultraBullet",
    ///     "chess960", "crazyhouse", "antichess", "atomic", "horde", "kingOfTheHill", "racingKings", "threeCheck", "bot",
    ///     "computer").
    /// </param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Stream of TV feed events.</returns>
    ...
    IAsyncEnumerable<GameJson> StreamChannelGamesAsync(string channel, TvChannelGamesOptions? options = null,
