...
public interface ITeamsApi
{
    ...
    IAsyncEnumerable<TeamMember> StreamMembersAsync(string teamId, bool full = false,
    ...
    Task<bool> JoinAsync(string teamId, string? message = null, string? password = null,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<TeamRequestWithUser>> GetJoinRequestsAsync(string teamId, bool declined = false,
        CancellationToken cancellationToken = default);
