...
public interface ISwissTournamentsApi
{
    ...
    Task<SwissTournament> CreateAsync(string teamId, SwissCreateOptions options,
    ...
    Task<SwissTournament> UpdateAsync(string id, SwissUpdateOptions options,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<GameJson> StreamGamesAsync(string id, SwissGamesExportOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<SwissPlayerResult> StreamResultsAsync(string id, int? nb = null,
        CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<SwissTournament> StreamTeamTournamentsAsync(string teamId, int? max = null,
        CancellationToken cancellationToken = default);
}
