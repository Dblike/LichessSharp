...
public interface IChallengesApi
{
    ...
    Task<ChallengeJson> CreateAsync(string username, ChallengeCreateOptions? options = null,
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>True if successful.</returns>
    Task<bool> DeclineAsync(string challengeId, ChallengeDeclineReason? reason = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>True if successful.</returns>
    Task<bool> CancelAsync(string challengeId, string? opponentToken = null,
        CancellationToken cancellationToken = default);
    ...
    Task<ChallengeAiResponse> ChallengeAiAsync(ChallengeAiOptions options,
        CancellationToken cancellationToken = default);
    ...
    Task<ChallengeOpenJson> CreateOpenAsync(ChallengeOpenOptions? options = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>True if successful.</returns>
    Task<bool> StartClocksAsync(string gameId, string? token1 = null, string? token2 = null,
        CancellationToken cancellationToken = default);
