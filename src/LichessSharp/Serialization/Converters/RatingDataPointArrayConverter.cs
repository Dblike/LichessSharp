...
{
    /// <inheritdoc />
    public override IReadOnlyList<RatingDataPoint> Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    /// <inheritdoc />
    public override void Write(Utf8JsonWriter writer, IReadOnlyList<RatingDataPoint> value, JsonSerializerOptions options)
    {
